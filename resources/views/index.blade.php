...
<script>
    document.getElementById("registerNow").addEventListener("click", function() {
        // Hapus kelas "active" dari tautan "Log in"
        document.querySelector(".login-register-tab-list a.active").classList.remove("active");
        // Tambahkan kelas "active" ke tautan "Register now"
