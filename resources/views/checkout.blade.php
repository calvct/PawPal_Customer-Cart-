...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="billing-info mb-4">
                                    ...
                                    <input type="emil" required name="email"/>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 mt-md-30px mt-lm-30px ">
                    <div class="your-order-area">
                            ...
                            <div class="your-order-product-info">
                                ...
                                <div class="your-order-middle">
                                    <ul>
                                        @foreach($datacart as $cart)
                                            <li><span class="order-middle-left"> {{$cart->PRODUCT_NAME}} </span> <span
                                                class="order-price">Rp {{ number_format($cart->SUBTOTAL, 0, ',', '.') }} </span></li>
                                        @endforeach
                                ...
                                <div class="your-order-bottom">
                                    <ul>
                                        ...
                                        <li>Rp {{ number_format(session('shipping'),0,',','.' )}}</li>
                                    </ul>
                                </div>
                                @php
                                $total = 0;
                        ...
                        <div class="Place-order mt-25">
                            @csrf
                            <a id="placeOrder" class="btn-hover" href="/my-account" data-route= "{{route('addOrder')}}">Place Order</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $('#placeOrder').click(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('addOrder') }}', // Laravel route for order processing
            data: {
                mydata: formData,
